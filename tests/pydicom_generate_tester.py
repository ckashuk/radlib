...
from pydicom_generate.dcm.dicom_generators import generate_valid_template_dcm, generate_dcm_pydicom
from pydicom_generate.dcm.dicom_loaders import load_dicom_series_from_slices
from pydicom_generate.dcm.dicom_standard_validation import load_dicom_standard, get_tag_id_key
import pydicom
...
slices1 = generate_dcm_pydicom('CT', pixel_data, origin=[100.0000, 100.0000, 0.0], spacing=[10.0, 10.0, 10.0])
